...
- **Supabase / PostgreSQL** — SQL bootstrap (`supabase/hisab_ai_supabase.sql`), migration scripts, and [SUPABASE_MIGRATION.md](./SUPABASE_MIGRATION.md) exist; the running app still uses SQLite.
...
├── docs/                           # Product & migration documentation
├── scripts/                        # Supabase apply/verify helpers
└── supabase/hisab_ai_supabase.sql  # Postgres schema + seed SQL
```
...
5. **PostgreSQL / Supabase** — complete migration per [SUPABASE_MIGRATION.md](./SUPABASE_MIGRATION.md)  
...
| File | Description |
|------|-------------|
| [docs/HISAB_AI_PRODUCT_CONTEXT.md](./HISAB_AI_PRODUCT_CONTEXT.md) | This document |
| [docs/SUPABASE_MIGRATION.md](./SUPABASE_MIGRATION.md) | Postgres / Supabase migration guide |
| [README.md](../README.md) | Setup, features, API overview, troubleshooting |
| [AGENTS.md](../AGENTS.md) | Next.js 16 agent development rules |
| [supabase/hisab_ai_supabase.sql](../supabase/hisab_ai_supabase.sql) | Full Postgres bootstrap SQL |
