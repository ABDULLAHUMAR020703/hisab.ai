...
export function mapZatcaCredentialRow(row: Record<string, unknown>): ZatcaCredentialRecord {
  ...
  return {
    ...
    productionBinarySecurityTokenEnc: (row.production_binary_security_token_enc as string | null) ?? null,
    ...
    complianceCertIssuedAt: toDate(row.compliance_cert_issued_at as string | null | undefined),
    complianceCertValidFrom: toDate(row.compliance_cert_valid_from as string | null | undefined),
    complianceCertValidTo: toDate(row.compliance_cert_valid_to as string | null | undefined),
    productionCertIssuedAt: toDate(row.production_cert_issued_at as string | null | undefined),
    productionCertValidFrom: toDate(row.production_cert_valid_from as string | null | undefined),
    productionCertValidTo: toDate(row.production_cert_valid_to as string | null | undefined),
