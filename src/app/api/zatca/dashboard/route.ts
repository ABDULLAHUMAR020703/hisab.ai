...
import { getZatcaDashboardStats, getZatcaRecentActivity } from '@/lib/zatca/monitoring'
...
export async function GET() {
  try {
    ...
    const [stats, activity, auditLogs, sandboxTests] = await Promise.all([
    ...
    return Response.json({ stats, activity, auditLogs, sandboxTests })
  } catch (error) {
